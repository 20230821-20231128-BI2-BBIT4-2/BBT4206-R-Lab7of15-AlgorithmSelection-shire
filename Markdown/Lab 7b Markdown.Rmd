...
```{r STEP 1: INSTALLATION AND LOADING OF REQUIRED PACKAGES}
...
```{r STEP 3:CHECKING FOR MISSING DATA AND ADDRESSING IT}
any_na(train)
...
```{r STEP 4:PERFORMING EDA AND FEATURE SELECTION}
...
```{r STEP 5:CREATING CLUSTERS USING K-MEANS CLUSTERING ALGORITHIM}
set.seed(7)
...
```{r STEP 6:ADDING CLUSTER NUMBER AS A LABEL FOR EACH OBSERVATION}
